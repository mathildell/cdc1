...
//========================================================================================================
  ...
  $db_server = DB_CONFIG::DB_HOST;      // server name
  $db_user = DB_CONFIG::DB_UN;             // user name
  $db_pass = DB_CONFIG::DB_PWD;                 // user password
  $db_name = DB_CONFIG::DB_NAME;                 // database name

  // don't change unless you know what you're doing:
  $tbl_name = "demo_Shoutbox";   // table name
...
//========================================================================================================
  ...
  $boxFolder = $_SERVER['DOCUMENT_ROOT'] . "/view/layout/includes/shoutbox";
